<div class="container">
    ...
    <div class="row text-center">
        <a href="index.php?page=accueil" class="img-thumbnail col-5 mr-1 mx-auto pb-5 pt-5 display-4"
           style="height: 200px;">OUI</a>
        <a href="index.php?page=accueil" class="img-thumbnail col-5 ml-1 mx-auto pb-5 pt-5 display-4"
