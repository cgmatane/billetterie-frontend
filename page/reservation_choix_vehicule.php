...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center text-warning p-4 font-weight-bold">Avez-vous un véhicule ?</h1>
        </div>
    </div>
    <div class="row text-center">
        <a href="index.php?page=" class="bg-white rounded-sm col-5 ml-1 mx-auto pb-5 pt-5 display-4"
