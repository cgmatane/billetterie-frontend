...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center text-warning p-4 font-weight-bold">Voyagerez-vous avec des matières dangereuses ?</h1>
        </div>
    </div>
    ...
    <div class="row text-center justify-content-center">
        <a href="index.php?page=reservation_choix_vehicule"><button type="button" class="btn btn-danger m-5 p-5">
                retour</button></a>
    </div>
</div>