...
<div class="container">
    ...
    <div class="text-center row justify-content-center">
        ...
        <a href="index.php?page=page1"><button type="button" class="btn btn-success mt-5 col-6 p-3" >Godbout</button></a><br>
            <a href="index.php?page=page1"><button type="button" class="btn btn-success col-6 mt-5 p-3" >Baie-Comeau</button></a>
        </div>
    </div>
